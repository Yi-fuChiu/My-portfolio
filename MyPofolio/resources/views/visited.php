...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./css/assignmentcss/visited.css">
...
<!-- Mobile Menu  -->
 ...
 <section>
   <div class='box'>
     <div class="image">
-        <img class='profile' src="./img/assignmentimg/japan.jpg">
             <h5>Japan</h5>
    ...
    <div class='box'>
      <div class="image">
 -        <img class='profile' src="./img/assignmentimg/thailand.jpg">
            <h5>Thailand</h5>
            <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
               incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
               exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
     ...
     <div class='box'>
       <div class="image">
  -        <img class='profile' src="./img/assignmentimg/india.jpg">
              <h5>India</h5>
               <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                  incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                  exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
      ...
      <div class='box'>
        <div class="image">
   -        <img class='profile' src="./img/assignmentimg/newyork.jpg">
              <h5>Ameria</h5>
              <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                 incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                 exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
       ...
       <div class='box'>
         <div class="image">
    -        <img class='profile' src="./img/assignmentimg/paris.jpg">
              <h5>France</h5>
               <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                  incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                  exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
